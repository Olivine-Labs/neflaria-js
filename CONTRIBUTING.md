Contributing to neflaria-js
===============================

So you want to contribute to neflaria-js? Fantastic! Here's a brief overview on
how best to do so.
...
[create an issue](https://github.com/Olivine-Labs/neflaria-js/issues) before putting
...
1. [Fork the repository](https://github.com/Olivine-Labs/neflaria-js/fork_select) to
  your Github account.
